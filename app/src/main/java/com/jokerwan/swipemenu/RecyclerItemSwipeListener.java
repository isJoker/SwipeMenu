 ...
 * WeChat：wjc398556712
 * Function：a listener which could set recyclerview swipeable
 */

public class RecyclerItemSwipeListener implements RecyclerView.OnItemTouchListener {

    private static final String TAG = "RecyclerItemSwipeListener";
    ...
    private RecyclerItemSwipeListener() {
    }

    public RecyclerItemSwipeListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
    ...
    public RecyclerItemSwipeListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public RecyclerItemSwipeListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public RecyclerItemSwipeListener setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
    }
    public RecyclerItemSwipeListener setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public RecyclerItemSwipeListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerItemSwipeListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public RecyclerItemSwipeListener setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public RecyclerItemSwipeListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    public RecyclerItemSwipeListener setSwipeable(boolean value) {
    ...
    public RecyclerItemSwipeListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerItemSwipeListener setUnSwipeableRows(Integer... rows) {
    ...
    public RecyclerItemSwipeListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public RecyclerItemSwipeListener setFgFade() {
